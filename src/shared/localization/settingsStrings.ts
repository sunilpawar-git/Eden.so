export const settingsStrings = {
    ...
    connectorGhost: 'Ghost',
    connectorRegular: 'Regular',
    connectorLight: 'Light',
    connectorBold: 'Bold',
    ...
    toolbarDescription: 'Drag icons between zones to customize what appears in the Hover Menu and Right-click Menu. Icons not placed in either zone will be hidden.',
    toolbarHoverMenuZone: 'Hover Menu',
    toolbarHoverMenuHint: 'Appears when you hover a node',
    toolbarContextMenuZone: 'Right-click Menu',
    toolbarContextMenuHint: 'Appears on right-click or \u201cMore\u2026\u201d',
    toolbarUnplacedZone: 'Available Icons',
    toolbarUnplacedHint: 'Click + to add, or drag to a zone above',
    toolbarReset: 'Reset to Default',
    toolbarResetConfirm: 'Restore the default icon placement?',
    toolbarAddToBar: '+ Hover',
    toolbarAddToMenu: '+ R-click',
    toolbarEmpty: 'Drag icons here',
    toolbarNoUnplaced: 'All icons are placed',
    toolbarMoveUp: 'Move up',
    toolbarMoveDown: 'Move down',
    toolbarRemove: 'Hide (moves to Available Icons)',
    toolbarMoreButton: '\u201cMore\u2026\u201d button always opens Right-click Menu',
};
